...
Title = "synepz intermal ui";
Text = "internal ui is loaded! if you have issue send me Onk#9718";
Duration = 5;
})
...
Version.Text = "synepz 1.0 | made by Onk#9718"
...
local function CLAL_fake_script() -- Settings.SettingsScript 
	...
	task.spawn(function()
		...
		script.Parent.Version.Text = string.format("%s | made by Onk#9718", shared.FakeInternal.Version)
	end)
end
